...
public class LPGInstancePreferencesTab extends InstancePreferencesTab {
	...
	protected FieldEditor[] createFields(Composite composite) {
		...
		execField = prefUtils.makeNewFileField(
				prefPage, this,
				prefService, IPreferencesService.INSTANCE_LEVEL, PreferenceConstants.P_JIKESPG_EXEC_PATH, "Generator executable",
		...
		includeDirectoriesField = prefUtils.makeNewDirectoryListField(
				prefPage, this,
				prefService, IPreferencesService.INSTANCE_LEVEL, PreferenceConstants.P_JIKESPG_INCLUDE_DIRS, "Include directories:",
