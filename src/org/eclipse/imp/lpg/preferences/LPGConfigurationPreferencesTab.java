...
public class LPGConfigurationPreferencesTab extends ConfigurationPreferencesTab {
	...
	public LPGConfigurationPreferencesTab(IPreferencesService prefService) {
		super(prefService);
	}
	...
	protected FieldEditor[] createFields(Composite composite) {
		...
		useDefaultExecField = prefUtils.makeNewBooleanField(
				prefPage, this,
				prefService, IPreferencesService.CONFIGURATION_LEVEL, PreferenceConstants.P_USE_DEFAULT_EXEC, "Use default generator executable?",
		...
		execField = prefUtils.makeNewFileField(
				prefPage, this,
				prefService, IPreferencesService.CONFIGURATION_LEVEL, PreferenceConstants.P_JIKESPG_EXEC_PATH, "Generator executable",
		...
		useDefaultGenIncludePathField = prefUtils.makeNewBooleanField(
				prefPage, this,
				prefService, IPreferencesService.CONFIGURATION_LEVEL, PreferenceConstants.P_USE_DEFAULT_INCLUDE_DIR, "Use default generator include path?",
		...
		includeDirectoriesField = prefUtils.makeNewDirectoryListField(
				prefPage, this,
				prefService, IPreferencesService.CONFIGURATION_LEVEL, PreferenceConstants.P_JIKESPG_INCLUDE_DIRS, "Include directories:",
		...
		extensionsToProcessField = prefUtils.makeNewStringField(
				prefPage, this,
				prefService, IPreferencesService.CONFIGURATION_LEVEL, PreferenceConstants.P_EXTENSION_LIST, "File-name extensions to process:",
		...
		extensionsToIncludeField = prefUtils.makeNewStringField(
				prefPage, this,
				prefService, IPreferencesService.CONFIGURATION_LEVEL, PreferenceConstants.P_NON_ROOT_EXTENSION_LIST, "File-name extensions for include files:",
		...
		emitDiagnosticMessagesField = prefUtils.makeNewBooleanField(
				prefPage, this,
				prefService, IPreferencesService.CONFIGURATION_LEVEL, PreferenceConstants.P_EMIT_MESSAGES, "Emit diagnostic messages during build?",
		...
		generateListingsField = prefUtils.makeNewBooleanField(
				prefPage, this,
				prefService, IPreferencesService.CONFIGURATION_LEVEL, PreferenceConstants.P_GEN_LISTINGS, "Generate listing files?",
